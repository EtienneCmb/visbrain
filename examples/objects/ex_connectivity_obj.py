...
s_obj_cu = SourceObj('sources', nodes, color='slategray', radius_min=10.,
                     symbol='ring')
sc.add_to_subplot(c_cuscol, row=1, col=0, title='Use custom colors')
sc.add_to_subplot(s_obj_cu, row=1, col=0)
sc.add_to_subplot(BrainObj('white'), use_this_cam=True, row=1, col=0)
