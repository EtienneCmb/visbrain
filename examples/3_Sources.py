...
s_cmap_vmin = -40					# Define a minimum
s_cmap_vmax = 21					# Define a maximum
s_cmap_under = 'gray'				# Every values under vmin are going to be gray
s_cmap_over = (0.1,0.1,0.1, 1)	# Every values over vmax are going to be black
...
vb = vbrain(s_xyz=s_xyz, s_color=s_color, s_data=s_data, s_radiusmin=s_radiusmin, s_radiusmax=s_radiusmax, s_opacity=s_opacity,
            s_cmap=s_cmap, s_cmap_vmin=s_cmap_vmin, s_cmap_vmax=s_cmap_vmax, s_cmap_under=s_cmap_under, s_cmap_over=s_cmap_over, cb_label=cb_label,
