...
* `Signal <http://visbrain.org/signal.html>`_ : data-mining module for signals inspections (see `Signal examples <http://visbrain.org/auto_examples/index.html#signal-examples>`_).
