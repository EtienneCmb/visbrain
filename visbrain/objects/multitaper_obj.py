...
class MultitaperObj(ImageObj):
    ...
    nperseg : int | 256
        ...
        function.
    c_parameter : int | 20
        Parameter 'c' described in doi:10.1155/2011/980805
    overlap : float | 0.
    ...
    def __init__(self, name, data=None, sf=1., nperseg=256, overlap=0.,
                 c_parameter=20, cmap='viridis', clim=None, vmin=None,
        ...
        # Compute multitaper spectrogram and set data to the ImageObj :
        if isinstance(data, np.ndarray):
            self.set_data(data, sf, nperseg, overlap, c_parameter, clim, cmap,
                          vmin, under, vmax, over, **kwargs)

    def set_data(self, data, sf=1., nperseg=None, overlap=None,
                 c_parameter=20, clim=None, cmap=None, vmin=None, under=None,
        ...
        kwargs['c_parameter'] = c_parameter

        # Try importing the library:
        if is_lspopt_installed():
