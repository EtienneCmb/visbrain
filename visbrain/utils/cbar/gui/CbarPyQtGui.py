...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.limTxt = QtWidgets.QCheckBox(self.groupBox_3)
        self.limTxt.setChecked(True)
        self.limTxt.setObjectName("limTxt")
        self.gridLayout_7.addWidget(self.limTxt, 5, 0, 1, 3)
        self.line_9 = QtWidgets.QFrame(self.groupBox_3)
        self.line_9.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.gridLayout_7.addWidget(self.line_9, 2, 1, 1, 1)
        self.digits = QtWidgets.QSpinBox(self.groupBox_3)
        self.digits.setMinimum(1)
        self.digits.setMaximum(6)
        self.digits.setProperty("value", 2)
        self.digits.setObjectName("digits")
        self.gridLayout_7.addWidget(self.digits, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.vminW, 2, 2, 1, 2)
        spacerItem1 = QtWidgets.QSpacerItem(39, 0, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 4, 2, 1, 1)
        self.vmaxChk = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setItalic(True)
        self.vmaxChk.setFont(font)
        self.vmaxChk.setObjectName("vmaxChk")
        self.gridLayout.addWidget(self.vmaxChk, 3, 0, 1, 1)
        self.vminChk = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setItalic(True)
        self.vminChk.setFont(font)
        self.vminChk.setObjectName("vminChk")
        self.gridLayout.addWidget(self.vminChk, 2, 0, 1, 1)
...
"color"))
        self.vmaxChk.setText(_translate("Form", "Vmax"))
        self.vminChk.setText(_translate("Form", "Vmin"))
